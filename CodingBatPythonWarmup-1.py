...
# sleep_in The parameter weekday is True if it is a weekday,
...
# if we are in trouble.We have two monkeys, a and b, and the parameters
#  a_smile and b_smile indicate if each is smiling. We are in trouble
